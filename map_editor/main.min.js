...
Y.type="range";Y.min=1;Y.max=128;Y.value=10;Y.step=1;Y.oninput=function(){A=this.valueAsNumber||1;this.nextElementSibling.innerHTML=A+" tiles";this.nextElementSibling.nextElementSibling.value=A;C()}.bind(Y);p.a(Y);Y=e("h4");Y.innerHTML=A+" tiles";Y.style["margin-top"]="2px";Y.style["margin-bottom"]="2px";p.a(Y);Y=e("input");Y.type="number";Y.style["margin-top"]="2px";Y.value=A;Y.min=1;Y.max=128;
Y.oninput=function(){A=this.valueAsNumber||1;this.previousElementSibling.innerHTML=A+" tiles";this.previousElementSibling.previousElementSibling.value=A;C()}.bind(Y);p.a(Y);Y=e("h4");Y.innerHTML="Height";Y.style["margin-bottom"]="2px";p.a(Y);Y=e("input");Y.type="range";Y.min=1;Y.max=128;Y.value=10;Y.step=1;Y.oninput=function(){B=this.valueAsNumber||1;this.nextElementSibling.innerHTML=B+" tiles";this.nextElementSibling.nextElementSibling.value=B;C()}.bind(Y);p.a(Y);Y=e("h4");Y.innerHTML=B+" tiles";
Y.style["margin-top"]="2px";Y.style["margin-bottom"]="2px";p.a(Y);Y=e("input");Y.type="number";Y.style["margin-top"]="2px";Y.value=B;Y.min=1;Y.max=128;Y.oninput=function(){B=this.valueAsNumber||1;this.previousElementSibling.innerHTML=B+" tiles";this.previousElementSibling.previousElementSibling.value=B;C()}.bind(Y);p.a(Y);

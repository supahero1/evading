...
#if __SECURE_SERVER__ == 1
  info.options |= LWS_SERVER_OPTION_REDIRECT_HTTP_TO_HTTPS | LWS_SERVER_OPTION_DO_SSL_GLOBAL_INIT;
  info.ssl_cert_filepath = "/etc/letsencrypt/live/__SERVER_NAME__/fullchain.pem";
  info.ssl_private_key_filepath = "/etc/letsencrypt/live/__SERVER_NAME__/privkey.pem";
#endif
